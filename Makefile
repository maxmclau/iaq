...
# Compiler FLAGS
##########################################################
GCC_FLAGS = -g -mmcu=$(TARGET) -O$(OPTIMIZATION) -DF_CPU=$(SYSTEM_CLOCK) -fpack-struct -fshort-enums -funsigned-bitfields -funsigned-char -Wall -Wstrict-prototypes -std=c99
